...
const createNotificationsFormSchema = (t: any) => z.object({
  type: z.enum(['all', 'mentions', 'none'], {
    error: (iss) =>
      iss.input === undefined
        ? t('validation.required', { field: t('settings.notifications.type') })
        : undefined,
  }),
          ...
          render={({ field }) => (
            <FormItem className='relative flex flex-row items-start space-y-0 space-x-3'>
              ...
              <div className='space-y-1 leading-none'>
                ...
                <FormDescription>
                  {t('settings.notifications.mobileSettingsDescription.prefix')}{' '}
                  <Link
                    to='/settings'
                    className='underline decoration-dashed underline-offset-4 hover:decoration-solid'
                  >
                    {t('settings.notifications.mobileSettingsDescription.linkText')}
                  </Link>{' '}
                  {t('settings.notifications.mobileSettingsDescription.suffix')}
                </FormDescription>
              </div>
            </FormItem>
          )}
