...
Revision ID: f1c5c1ecd7ef
Revises: f5bd3258a84a
Create Date: 2025-08-19 17:55:40.811973
...
revision: str = 'f1c5c1ecd7ef'
down_revision: Union[str, None] = 'f5bd3258a84a'
...
def upgrade() -> None:
    ...
    sa.Column('slug', sa.String(length=100), nullable=True, comment='租户标识符'),
    sa.Column('domain', sa.String(length=255), nullable=True, comment='自定义域名'),
    sa.Column('subdomain', sa.String(length=100), nullable=True, comment='子域名'),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True, comment='删除时间'),
    sa.Column('deleted_by', sa.String(length=50), nullable=True, comment='删除者ID'),
    ...
    sa.Column('user_type', sa.String(length=20), nullable=False, comment='用户类型：individual个人用户，enterprise企业用户，system系统用户'),
